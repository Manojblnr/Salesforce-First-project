...
export default class WireDemo extends LightningElement {
    ...
    record;      //data and Error
    // notes:
        // This is the wire service in action. It says, "Wire this component to the getRecord service.
        // Fetch the record with the specified ID (recordId), and get the 'name' and 'phone' fields. 
        // Store the result in the 'record' property, which includes both the data and any errors.
